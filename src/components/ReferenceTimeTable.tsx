            ...
            <div className="overflow-hidden bg-white shadow-sm border border-[#e3d6d4]">
                <table className="w-[100%] border-collapse text-sm text-slate-700">
                    ...
                    <tbody className="text-sm text-slate-700">
                        ...
                        <tr>
                            <td className="border-r border-b border-[#e0e0e0] px-4 py-3 align-middle text-sm">オフ/フィルイン</td>
                            <td rowSpan={2} className="border-r border-b border-[#e0e0e0] px-4 py-3 text-center text-xs">タイム</td>
                        ...
                        <tr>
                            <td className="border-r border-b border-[#e0e0e0] px-4 py-3 align-middle text-sm">
                                プレパレーション
                            </td>
                        ...
                        <tr>
                            <td className="border-r border-b border-[#e0e0e0] px-4 py-3 align-top text-sm" rowSpan={4}>
                                <div className="flex flex-col h-full justify-center">
                                    <span className="font-semibold">ワンカラー</span>
                                </div>
                            </td>
                            <td className="border-r border-b border-[#e0e0e0] px-4 py-3 text-left text-xs">
                                ベース
                            </td>
